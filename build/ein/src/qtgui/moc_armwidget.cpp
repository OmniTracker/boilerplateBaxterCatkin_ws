...
#include "../../../../src/ein/src/qtgui/armwidget.h"
...
struct qt_meta_stringdata_ArmWidget_t {
    QByteArrayData data[3];
    char stringdata[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ArmWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_ArmWidget_t qt_meta_stringdata_ArmWidget = {
    {
QT_MOC_LITERAL(0, 0, 9),
QT_MOC_LITERAL(1, 10, 17),
QT_MOC_LITERAL(2, 28, 0)
    },
    "ArmWidget\0replReturnPressed\0\0"
};
...
void ArmWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->replReturnPressed(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ArmWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ArmWidget.data,
      qt_meta_data_ArmWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ArmWidget.stringdata))
